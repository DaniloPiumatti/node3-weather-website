...
const forecast = (longitude, latitude, callback) => {
    ...
    const url = 'http://api.weatherstack.com/current?access_key=397a9ea43d05600dc7d1c4413c8c2eeb&query=' + encodeURIComponent(latitude) + ',' + encodeURIComponent(longitude)
